...
SELECT DISTINCT Facilities.name, Members.firstname
FROM (
(
Bookings
...
select Facilities.name, Members.firstname+' '+Members.surname AS name,
...
and( 
(Members.memid = 0 and Bookings.slots * Facilities.guestcost>30) or (Members.memid <> 0 and Bookings.slots * Facilities.membercost>30)
    )
Order by cost desc
